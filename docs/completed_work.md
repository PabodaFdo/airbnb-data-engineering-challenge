...
Pricing and performance by room type.
Neighbourhood pricing and market activity.
Host portfolio concentration.
Superhost versus non-superhost performance.
Neighbourhood review activity.
Frequently reviewed but lower-rated listings.
Availability-based proxy patterns.
Pricing by accommodation capacity.
...
96 missing summary-listing host IDs.
3,994 missing summary-listing prices.
96 canonical summary listings absent from detailed listings.
3,992 missing detailed-listing prices.
Fully empty neighbourhood_group.
22,541 repeated (listing_id, date) summary-review rows.
